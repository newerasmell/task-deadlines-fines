...
// abstract translation keys — the source text itself is the key. Same
// convention as ../../../web/src/i18n (the sibling task-deadlines app).
export function I18nProvider({ children }: { children: ReactNode }) {
  const [lang, setLangState] = useState<Lang>(() => {
    const saved = typeof window !== "undefined" ? localStorage.getItem("pp.lang") : null;
