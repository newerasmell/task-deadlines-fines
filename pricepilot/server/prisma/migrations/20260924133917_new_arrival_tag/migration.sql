...
CREATE TABLE "new_Store" (
    ...
    "newArrivalTag" TEXT NOT NULL DEFAULT 'c_newcollection',
    "ga4PropertyId" TEXT,
...
INSERT INTO "new_Store" ("createdAt", "currency", "ga4PropertyId", "groupId", "id", "markdownAfterDays", "markdownCeilingPct", "markdownCollectionId", "markdownEnabled", "marketCode", "minMarginPct", "myshopifyDomain", "name", "priceEnding", "pricingProfile", "pricingStrategy", "salesAnalyticsEnabled", "shopifyClientId", "shopifyClientSecret", "undercutPct", "updatedAt") SELECT "createdAt", "currency", "ga4PropertyId", "groupId", "id", "markdownAfterDays", "markdownCeilingPct", "markdownCollectionId", "markdownEnabled", "marketCode", "minMarginPct", "myshopifyDomain", "name", "priceEnding", "pricingProfile", "pricingStrategy", "salesAnalyticsEnabled", "shopifyClientId", "shopifyClientSecret", "undercutPct", "updatedAt" FROM "Store";
DROP TABLE "Store";
