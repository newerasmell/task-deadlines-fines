...
INSERT INTO "new_VoiceTaskDraft" ("approvedAt", "approvedTaskId", "assigneeKey", "chainGroupId", "chainOrder", "chainTitle", "createdAt", "createdByAi", "deadline", "delayDaysAfterPrevious", "description", "id", "priority", "resolvedAssigneeId", "sourceQuote", "status", "title", "transcriptId", "updatedAt") SELECT "approvedAt", "approvedTaskId", "assigneeKey", "chainGroupId", "chainOrder", "chainTitle", "createdAt", "createdByAi", "deadline", "delayDaysAfterPrevious", "description", "id", "priority", "resolvedAssigneeId", "sourceQuote", "status", "title", "transcriptId", "updatedAt" FROM "VoiceTaskDraft";
