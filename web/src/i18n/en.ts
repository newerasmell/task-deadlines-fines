...
export const en: Record<string, string> = {
  ...
  "Въведи определение за завършена задача за стъпка {n}.": "Enter a Definition of Done for step {n}.",
  "Определение за завършена задача": "Definition of Done",
  "Какво точно трябва да е готово, за да се счита задачата за завършена?": "What exactly needs to be done for this task to count as complete?",
  ...
  "Задачите, за които си изпълнител, плюс тези, подадени за преглед на теб като Owner — независимо от ролята ти в системата.":
    "The tasks you're the assignee on, plus ones submitted for review to you as Owner — regardless of your role in the system.",
  "Няма задачи, чакащи твоя преглед.": "No tasks waiting on your review.",
  ...
  // Voice-to-tasks
  "Задачи от разговор": "Tasks from a recording",
  "Чакащи одобрение": "Pending approval",
  "Качи запис или го направи направо тук — системата ще го разпознае и ще извлече задачите като чернови за одобрение.":
    "Upload a recording or make one right here — it'll be transcribed and the tasks extracted as drafts for approval.",
  "Запиши": "Record",
  "Записва се…": "Recording…",
  "...или качи файл (mp3, m4a, wav, webm, ogg)": "...or upload a file (mp3, m4a, wav, webm, ogg)",
  "Този браузър не поддържа запис на звук.": "This browser doesn't support audio recording.",
  "Микрофонът е отказан или недостъпен — провери разрешенията на браузъра.":
    "Microphone access denied or unavailable — check your browser permissions.",
  "Качване…": "Uploading…",
  "Готово — открити {n} задача/и.": "Done — found {n} task(s).",
  "Готово.": "Done.",
  "Грешка при разпознаване — опитай отново.": "Recognition error — try again.",
  "Грешка при проверка на статуса.": "Error checking status.",
  "Прегледай чернови →": "Review drafts →",
  "Изчаква…": "Waiting…",
  "Разпознаване на реч…": "Recognizing speech…",
  "Извличане на задачи…": "Extracting tasks…",
  "Готово": "Done",
  "Няма чернови тук.": "No drafts here.",
  ...
  "{n} задачи": "{n} tasks",
  "(празен транскрипт — Whisper не е разпознал говор)": "(empty transcript — Whisper didn't recognize any speech)",
  "Изпълнител": "Assignee",
  "Неопределен": "Unassigned",
  "— Избери —": "— Choose —",
  "Избери изпълнител, преди да одобриш.": "Choose an assignee before approving.",
  "Определението за завършена задача е задължително, преди да одобриш.": "The Definition of Done is required before approving.",
  "AI предложение": "AI suggestion",
  "Предложения от AI:": "AI suggestions:",
  "Предложения от AI": "AI suggestions",
  'Наистина ли да отхвърля "{title}"?': 'Reject "{title}"?',
  "Одобрени: {n}. Пропуснати (одобри ги поотделно): {list}": "Approved: {n}. Skipped (approve individually): {list}",
  "Чернова": "Draft",
  "Възложена": "Assigned",
  ...
  'Понякога Jitsi показва рекламен екран върху срещата (техен проблем, не наш) и може да извади участник от разговора. Ако това стане на теб или колега: натисни "Опресни връзката" горе.':
    'Jitsi occasionally shows a promo screen over the call (their issue, not ours) and it can knock a participant out. If that happens to you or a colleague: click "Refresh connection" above.',
  "или": "or",
  "постави връзка/код на среща": "paste a meeting link/code",
  "Присъедини се": "Join",
